<?php
/*
Template Name: Template - No Navigation or Sidebar
*/
/**
 * Page with No Navigation Bar or Sidebar Template
 *
 * This template removes the "Next Post" and "Previous Post" navigation at the bottom of the page.
 * It also removes the sidebar completely.
 *
 * @package supreme
 * @subpackage Template
 */
