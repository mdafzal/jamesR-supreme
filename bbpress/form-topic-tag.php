		...
		<div class="bbp-form" id="bbp-edit-topic-tag">
			...
			<div id="tag-rename">
				...
				<div class="bbp-template-notice info">
					<p><?php _e( 'Leave the slug empty to generate it automatically.', 'bbpress' ); ?></p>
				</div>

				<div class="bbp-template-notice">
					<p><?php _e( 'Changing the slug affects its permalink. Any link to the old slug will stop working.', 'bbpress' ); ?></p>
				</div>
