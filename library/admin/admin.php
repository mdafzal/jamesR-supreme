...
add_action('admin_menu','supreme_templatic_menu',10);
add_action('admin_menu','delete_supreme_templatic_menu',11);
/*
...
function supreme_templatic_menu(){
	...
	add_menu_page('Templatic', 'Templatic', 'administrator', 'templatic_menu', 'tmpl_framework_update', '',500); 
	
}
/*
	Supreme delete menu 
*/	
function delete_supreme_templatic_menu(){
	remove_submenu_page('templatic_menu', 'templatic_menu'); 
}

/* framework update form*/
function tmpl_framework_update()
{
	include_once(get_template_directory()."/templatic_login.php");
}
