...
if ( is_active_sidebar( 'subsidiary-2c' ) ) : ?>
	...
	<?php do_atomic( 'before_sidebar_subsidiary_2c' ); // supreme_before_sidebar_subsidiary_2c ?>

	<div id="sidebar-subsidiary-2c" class="sidebar sidebar-2c sidebar-subsidiary">
	
		<div class="sidebar-wrap">

			<?php do_atomic( 'open_sidebar_subsidiary_2c' ); // supreme_open_sidebar_subsidiary_2c ?>

			<?php dynamic_sidebar( 'subsidiary-2c' ); ?>

			<?php do_atomic( 'close_sidebar_subsidiary_2c' ); // supreme_close_sidebar_subsidiary_2c ?>
		
		</div><!-- .sidebar-wrap -->

	</div><!-- #sidebar-subsidiary-2c -->

	<?php do_atomic( 'after_sidebar_subsidiary_2c' ); // supreme_after_sidebar_subsidiary_2c ?>
