...
if ( has_nav_menu( 'header-horizontal' ) ) : ?>
	...
	<?php do_atomic( 'before_menu_header_horizontal' ); // supreme_before_menu_header_horizontal ?>

	<div id="menu-header-horizontal" class="menu-container">

		<div class="wrap">

			<?php do_atomic( 'open_menu_header_horizontal' ); // supreme_open_menu_header_horizontal ?>
			...
			<?php do_atomic( 'close_menu_header_horizontal' ); // supreme_close_menu_header_horizontal ?>

		</div>

	</div><!-- #menu-header-horizontal .menu-container -->

	<?php do_atomic( 'after_menu_header_horizontal' ); // supreme_after_menu_header_horizontal ?>
