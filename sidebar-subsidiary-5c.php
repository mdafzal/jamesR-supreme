...
if ( is_active_sidebar( 'subsidiary-5c' ) ) : ?>
	...
	<?php do_atomic( 'before_sidebar_subsidiary_5c' ); // supreme_before_sidebar_subsidiary_5c ?>

	<div id="sidebar-subsidiary-5c" class="sidebar sidebar-5c sidebar-subsidiary">
	
		<div class="sidebar-wrap">

			<?php do_atomic( 'open_sidebar_subsidiary_5c' ); // supreme_open_sidebar_subsidiary_5c ?>

			<?php dynamic_sidebar( 'subsidiary-5c' ); ?>

			<?php do_atomic( 'close_sidebar_subsidiary_5c' ); // supreme_close_sidebar_subsidiary_5c ?>
		
		</div><!-- .sidebar-wrap -->

	</div><!-- #sidebar-subsidiary-5c -->

	<?php do_atomic( 'after_sidebar_subsidiary_5c' ); // supreme_after_sidebar_subsidiary_5c ?>
